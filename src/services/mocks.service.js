...
import { usersService } from '../services/index.js';  // Ajusta la ruta según la ubicación de tu archivo
import { petsService } from '../services/index.js';   // Ajusta la ruta según la ubicación de tu archivo
